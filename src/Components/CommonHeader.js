import classes from "./Commomheader.module.css";
  ...
  return (
    <>
      <header className={classes.header}>
        {/* <Container className={classes.mui_container}> */}
        {/* <div className={classes.mui_container_root_}> */}
        <div className={classes.mui_container_root_homeicon_left}>
          <Link to={"/Homepage"}>
            <HomeOutlinedIcon
              sx={{
                width: "70px",
        ...
        <div className={classes.mui_container_root_logout_right}>
          <button
          ...
          <div className={classes.header__user_avatar}>
            <button
              style={{
                border: "0",
